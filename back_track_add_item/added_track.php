...
<header class="header">
            <div class="header__container">
                ...
                <p href="#" class="header__logo" style="margin-top: 12px">AddedStock</p>
            ...
            <nav class="nav__container">
                <div>
                    <a href="#" class="nav__link nav__logo">
                        ...
                        <span class="nav__logo-name" style="font-size: 15px">AddedStock</span>
                    </a>
                            ...
                            <div class="nav__dropdown">
                                ...
                                <div class="nav__dropdown-collapse">
                                    <div class="nav__dropdown-content">
                                        <a href="#" class="nav__dropdown-item">Added Stock</a>
