...
<link rel="stylesheet" href="side_bar.css">
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css"
        integrity="sha512-DTOQO9RWCH3ppGqcWaEA1BIZOC6xxalwEsw9c2QQeAIftl+Vegovlnee1c9QX4TctnWMn13TZye+giMm8e2LwA=="
        crossorigin="anonymous" referrerpolicy="no-referrer" />
        <link href="https://fonts.googleapis.com/css2?family=Baloo+2:wght@400..800&family=Funnel+Display:wght@300..800&family=Noto+Serif+Oriya:wght@400..700&display=swap" rel="stylesheet">
<style>
    h2{
  ...
  font-style: normal;
    ...
    body{
        background:url(../images/5591276.jpg);
...
<body>
            ...
            <nav class="nav__container">
                <div>
                    <a href="#" class="nav__link nav__logo">
                        ...
                        <span class="nav__logo-name" style="font-size: 15px">Backup_Backup</span>
                    </a>
  ...
  <div class="container p-4 " >
    <div class="d-flex align-items-center">
      <!-- Left Side: Image -->
      <div class="me-4">
        <img src="../images/4022440.jpg" alt="Image" class="img-fluid rounded" style="max-width: 650px;">
      </div>
      <!-- Right Side: Text and Form -->
      <div>
        <h2 class="mb-4" style="font-weight: bold; color: #343a40;">Backup Database</h2>
        <p style="color: #6c757d;">
  Click the button below to back up the database. This will create a secure copy of your data and send it to your Gmail for safekeeping and recovery purposes.
</p>
        
        <!-- Form -->
        <form action="" method="post">
        
          <button class="button"  type="submit" name="backup">
     <span class="button-content">Back Up Database </span>
</button>
        </form>
      </div>
    </div>
...
<script>
    ...
    if (isset($_SESSION['Sucessfully'])) { ?>
        ...
        alertify.success('<?php echo $_SESSION['Sucessfully']; ?>');
        <?php unset($_SESSION['Sucessfully']); ?>
    <?php } ?>
