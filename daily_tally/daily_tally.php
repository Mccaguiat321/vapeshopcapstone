...
<header class="header">
            <div class="header__container">
                ...
                <p href="#" class="header__logo" style="margin-top: 12px">TALLY </p>
            ...
            <nav class="nav__container">
                <div>
                    <a href="#" class="nav__link nav__logo">
                        ...
                        <span class="nav__logo-name" style="font-size: 15px">TALLY</span>
                    </a>
...
<div class="d-flex">
        <div class="mb-3">
    <input type="text" id="searchInputssss"  placeholder="Search for flavors..."  style="margin-right: 10px" class="form-control" />
</div>
...
<button id="printBtn" class="btn mb-3 topbutton" onclick="printTable()" style="margin-right: 10px"><i class="fa-solid fa-print"></i></button>
            ...
            <div id="tablenaten" class="table-responsive" style="height: 615px; width: 100%; overflow: auto;box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px; border-radius: 15px; padding: 0;margin-top: 5px">
    <table class="table text-center" id="userTable" style="border-radius: 15px; border-collapse: collapse; width: 100%; margin: 0;">
        <thead class="table sticky" style="border-top-left-radius: 15px; border-top-right-radius: 15px;">
            <tr>  
...
<!-- <script>
    function filterTableSS() {
        ...
        for (let i = 0; i < tr.length; i++) {
            ...
            // Ensure there are at least 6 columns to check
            if (tds.length >= 6) {
                const txtValue0 = tds[0].textContent.toLowerCase(); // Index 0
                const txtValue1 = tds[1].textContent.toLowerCase(); // Index 1
                const txtValue2 = tds[2].textContent.toLowerCase(); // Index 2
                const txtValue3 = tds[3].textContent.toLowerCase(); // Index 3
                const txtValue4 = tds[4].textContent.toLowerCase(); // Index 4
                const txtValue5 = tds[5].textContent.toLowerCase(); // Index 5
                
                // Check if any of the values contain the filter text
                if (txtValue0.indexOf(filter) > -1 || 
                    txtValue1.indexOf(filter) > -1 || 
                    txtValue2.indexOf(filter) > -1 || 
                    txtValue3.indexOf(filter) > -1 || 
                    txtValue4.indexOf(filter) > -1 || 
                    txtValue5.indexOf(filter) > -1) {
