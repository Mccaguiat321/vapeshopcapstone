...
<header class="header">
            <div class="header__container">
                ...
                <p href="#" class="header__logo" style="margin-top: 12px">ACCOUNTS</p>
...
<button type="button " class="btn mb-3 topbutton" style="border:  1px solid #0b0e2d;margin-right: 10px"
title="Add Account"
                data-toggle="modal" data-target="#exampleModal">
                <i class="fa-solid fa-plus"></i>
            </button>
<button id="downloadBtn" class="btn mb-3 topbutton" title="Download"onclick="downloadTable()" style="margin-right: 10px"><i class="fa-solid fa-download"></i></button>
    <button id="printBtn" class="btn mb-3 topbutton" title="Print" onclick="printTable()" style="margin-right: 10px"><i class="fa-solid fa-print"></i></button>
</div>
            <div id="tablenaten" class="table-responsive" style="height: 615px; width: 100%; overflow: auto;box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px; border-radius: 15px; padding: 0;">
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="transform: translateY(-8px);">
                            ...
                            <form method="post">
                                ...
                                <button type="submit" name="createacc" class="btn topbutton">Create</button>
                            </form>
                        </div>
