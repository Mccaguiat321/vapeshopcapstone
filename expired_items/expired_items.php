...
<header class="header">
            <div class="header__container">
                ...
                <p href="#" class="header__logo" style="margin-top: 12px">Exipired Items</p>
                            ...
                            <div class="nav__dropdown">
                                ...
                                <div class="nav__dropdown-collapse">
                                    <div class="nav__dropdown-content">
                                        ...
                                        <a href="#" class="nav__dropdown-item">Expired Items</a>
...
<button id="printBtn" class="btn mb-3 topbutton"
title="Print"
onclick="printTable()" style="margin-right: 10px"><i class="fa-solid fa-print"></i></button>
...
<script>
    function filterTableSS() {
        ...
        for (let i = 0; i < tr.length; i++) {
            const tdID = tr[i].getElementsByTagName('td')[0]; // ID column index
            const tdCategory = tr[i].getElementsByTagName('td')[1]; // Category column index
            const tdBrand = tr[i].getElementsByTagName('td')[2]; // Brand column index
            const tdFlavor = tr[i].getElementsByTagName('td')[3]; // Flavor column index
            const tdDescription = tr[i].getElementsByTagName('td')[4]; // Description column index
            const tdCost = tr[i].getElementsByTagName('td')[7]; // Cost column index
            const tdPrice = tr[i].getElementsByTagName('td')[8]; // Price column index
            
            // Check if any of the relevant cells exist
            if (tdID || tdCategory || tdBrand || tdFlavor || tdDescription || tdCost || tdPrice) {
                const txtValueID = tdID.textContent || tdID.innerText;
                const txtValueCategory = tdCategory.textContent || tdCategory.innerText;
                const txtValueBrand = tdBrand.textContent || tdBrand.innerText;
                ...
                const txtValueCost = tdCost.textContent || tdCost.innerText;
                ...
                if (
                    ...
                    txtValueCost.toLowerCase().indexOf(filter) > -1 ||
